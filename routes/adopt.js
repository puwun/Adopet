...
router.delete('/dogs/:id', catchAsync(adopt.deleteOneDog))
...
router.delete('/cats/:id',catchAsync(adopt.deleteOneCat))
...
router.delete('/smallandfurries/:id',isLoggedIn,catchAsync(adopt.deleteOneSmallandfurry))
...
router.delete('/others/:id',isLoggedIn ,catchAsync(adopt.deleteOneOther))
